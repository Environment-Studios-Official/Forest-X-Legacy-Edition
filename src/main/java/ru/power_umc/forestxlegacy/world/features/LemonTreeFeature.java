...
package ru.power_umc.forestxlegacy.world.features;

import ru.power_umc.forestxlegacy.procedures.CheckingGrassBlockProcedure;
...
public class LemonTreeFeature extends Feature<NoneFeatureConfiguration> {
	private final List<Block> base_blocks;
	private StructureTemplate template = null;

	public LemonTreeFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("forest_legacy", "lemon_tree_fix"));
		if (template == null)
			return false;
