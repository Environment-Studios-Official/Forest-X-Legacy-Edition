...
public class Cranberrybush1PriNazhatiiPravoiKnopkiMyshiNaRastieniiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(ForestLegacyModItems.CRANBERRY.get());
			_setstack.setCount(6);
			ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
		}
		world.setBlock(BlockPos.containing(x, y, z), ForestLegacyModBlocks.CRANBERRYBUSH_0.get().defaultBlockState(), 3);
	}
}
